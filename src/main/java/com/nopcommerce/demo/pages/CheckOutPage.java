...
public class CheckOutPage extends Utility {
    ...
    public void enterLogindetailsAndClickOnLoginButton() {
     log.info("Enter login details"+loginLink.toString()+"<br>");
        sendTextToElement(loginLink, "abcd123@gmail.com");
    ...
    public void enterMandatoryDetails() {
       ...
       log.info("Select State"+stateSelection.toString()+"<br>");
        ...
        log.info("Enter PhoneNumber"+phoneNumber.toString()+"<br>");
        sendTextToElement(phoneNumber, "1234567890");
        log.info("Continue"+continue5.toString()+"<br>");
    ...
    public void enterCardDetails() {
     ...
     log.info("Enter Card number"+cardNumber.toString()+"<br>");
        ...
        log.info("Enter CVV Code"+cvvCode.toString()+"<br>");
    ...
    public void clickOnLogOutLink() {
        log.info("Click On logout Link"+logoutLink.toString()+"<br>");
        clickOnElement(logoutLink);

    }

    public String verifyCurrentUrl() {
     log.info("Get text of Current URL"+driver.getCurrentUrl()+"<br>");
